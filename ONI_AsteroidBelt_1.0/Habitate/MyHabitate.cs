...
{
    internal class MyHabitate : IBuildingConfig
    {
        ...
        {
            string id = "MyHabitatModuleMedium";
            int width = 5;
            int height = 3;
            string anim = "rocket_habitat_medium_module_kanim";
            int hitpoints = 1000;
            float construction_time = 60f;
            float[] dense_TIER = TUNING.BUILDINGS.ROCKETRY_MASS_KG.DENSE_TIER1;
		...
		public const string ID = "MyHabitatModuleMedium";
